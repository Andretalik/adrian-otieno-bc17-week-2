...
class TestAddPerson(unittest.TestCase):
    ...
    def test_person_accommodation(self):
        ...
        self.test_case_instance.create_room("livingspace", "Drangleic")
        ...
        # print(test_case_instance.livingspaces[0].room_name)
        # print(test_case_instance.all_people[0].room_assigned)
        self.assertEqual(self.test_case_instance.all_people[0].room_assigned.room_name, self.test_case_instance.all_rooms[0].room_name, "Person hasn't been assigned a room")